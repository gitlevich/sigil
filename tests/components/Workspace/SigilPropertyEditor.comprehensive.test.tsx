...
vi.mock("../../../src/actions/workspace", async (importOriginal) => {
...
import { SigilPropertyEditor, getDragPropertySource, clearDragPropertySource, slugify } from "../../../src/components/Workspace/SigilPropertyEditor";
import type { ActionDeps } from "../../../src/actions/workspace";
