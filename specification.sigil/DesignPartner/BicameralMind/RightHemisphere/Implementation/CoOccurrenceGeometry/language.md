...
Each @sigil is a sphere. Radius from content volume. Surface from @affordances. Boundary rigidity from @invariants. The @DesignPartner sees every @sigil from outside as a sphere. His own @sigil is the exception — he inhabits it, so its internal topology matters.
