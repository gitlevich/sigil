...
A sigil has affordances. They belong to the sigil. They are only relevant within the context of the containing sigil, where siblings can address them.
...
Affordances are declared in the narration — what the user can do with the application, or what a contained sigil provides to its siblings. They are grouped into @Experiences. The number of affordances is not capped, but keeping it reasonable avoids overwhelming the context.
