...
A single edit: a delta to a sigil's narration, timestamped, with a snapshot of the upstream state at the moment it was written — what the trajectories above contained when this change happened.
