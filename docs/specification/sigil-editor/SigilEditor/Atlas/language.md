...
I can #navigate into any context by double-clicking. I can toggle between focused (one level) and revealed (all levels). Right-click gives me the same operations as the @OntologyTree: rename, delete, open in Finder.
