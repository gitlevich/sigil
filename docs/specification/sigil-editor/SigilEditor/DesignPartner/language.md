...
**@Coverage.** The vision sentences are trajectories through the @sigil tree. The partner traces each one and finds where it falls off the edge. The shape of the gap constrains what fills it (@Coverage!gravity). The partner surfaces gaps and degrees of freedom; the author decides (@Coverage!author-decides). @Coverage is complete when every vision sentence traces without falling off and every leaf is collapsed or in declared superposition.