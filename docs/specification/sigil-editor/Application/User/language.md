...
This is where I specify my @invariants and @affordances I expose to my @DesignPartner.

@DesignPartner, in turn, exposes his to me.

the UI-sounding @sigils, like @Application, are powered by my @attention. They are my surfaces of interaction with the @sigil I am envisioning and @DesignPartner that helps me with that.
...
@ChatPanel is the @entanglement membrane between me and @DesignPartner to #chat. I can also see his memories in @MemoriesPanel