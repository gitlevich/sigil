...
Each narration is an @Edit. Edits accumulate into @Narrative — the growth history of the trajectory at that sigil. The Edit history is the time-like dimension: it records how the trajectory came to be, in what order direction was added, where attention was concentrated.
...
@Signals are the dimensions I name as things I care about — each with a preferred range. @Affordances are the capabilities a contained sigil exposes to its siblings. @Experience groups affordances into coherent patterns of use.
